...
static int log10Pow2(int x) {
	return (x * 78913) >> 18;
}

static int log2Pow10(int x) {
	return (x * 108853) >> 15;
}
...
static void Format(char *dst, uint64_t d, int p, int nd) {
...
void uscale_short(double f, char *dst) {
	// Handle zero.
	uint64_t bits;
